...
public static void main(String[] args) {
    ...
    //iniciar as variaveis para contar os votos
    long voto1 = 0, voto2 = 0, voto3 = 0, voto4 = 0, votoNulo = 0, votoBranco = 0;
     byte voto;
     
    //repetir os comandos
    do{
    System.out.println("Informe o voto (de 1 à 4)");
    ...
    switch (voto) {
      ...
      System.out.println("Votos Candidatos 1" + voto1);
      System.out.println("Votos Candidatos 2" + voto2);
      System.out.println("Votos Candidatos 3" + voto3);
      System.out.println("Votos Candidatos 4" + voto4);
      ...
      System.out.println("Percentual de Brancos e Nulos" + (float) (votoNulo + votoBranco) / totalVotos * 100.0);
}
}
